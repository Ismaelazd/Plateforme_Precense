(function () {
    ...
    $(function () {
      $('#error').novacancy({
        ...
        'loopMax': 10,
        'color': '#ffffff',
        'glow': ['0 0 80px #ffffff', '0 0 30px Blue', '0 0 6px #0000ff'] });
  
      return $('#code').novacancy({
        'blink': 1,
        'off': 1,
        'color': 'Blue',
        'glow': ['0 0 80px Blue', '0 0 30px FireBrick', '0 0 6px DarkBlue'] });
