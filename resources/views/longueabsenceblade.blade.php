        ...
        <div class="profile-content">
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class=" card col-lg-9 mx-auto p-0">
                        <div class="card-header w-100 text-white" style="background-color: #120851;">
                        <h3 class="card-title text-center" >Absence longue</h3> 
                        </div> 
